...
public class EmailTemplatesTest {
    ...
    @Test
    public void testEmailTemplateForWelcome() {
        String result = emailTemplates.emailTemplateForWelcome(user);
        assertEquals("<!DOCTYPE html>\n" +
                ...
                "                                                        <p style=\"margin: 0; font-size: 12px; text-align: center;\"><span style=\"\">Copyright © 2022 Bike Service, All rights reserved.<br/><br/></span></p>\n" +
    ...
    @Test
    public void testEmailTemplateForResetPassword() {
        String result = emailTemplates.emailTemplateForResetPassword(user);
        assertEquals("<!DOCTYPE html>\n" +
                "\n" +
                "<html lang=\"en\" xmlns:o=\"urn:schemas-microsoft-com:office:office\" xmlns:v=\"urn:schemas-microsoft-com:vml\">\n" +
                "<head>\n" +
                ...
                "                                                <div style=\"font-family: sans-serif\">\n" +
                "                                                    <div style=\"font-size: 14px; mso-line-height-alt: 16.8px; color: #f7f7f7; line-height: 1.2; font-family: Varela Round, Trebuchet MS, Helvetica, sans-serif;\">\n" +
                "                                                        <p style=\"margin: 0; font-size: 14px; text-align: center;\"><span style=\"font-size:30px;\">Hello " + user.getFirstName() + " " + user.getLastName() + "</span></p>\n" +
                "                                                    </div>\n" +
                "                                                </div>\n" +
                "                                            </td>\n" +
                "                                        </tr>\n" +
                ...
                "                                                <div style=\"font-family: sans-serif\">\n" +
                "                                                    <div style=\"font-size: 12px; mso-line-height-alt: 18px; color: #f7f7f7; line-height: 1.5; font-family: Varela Round, Trebuchet MS, Helvetica, sans-serif;\">\n" +
                "                                                        <p style=\"margin: 0; font-size: 14px; text-align: center;\"><span style=\"font-size:26px;\">We have received your request to reset password.</span></p>\n" +
                "                                                        <p style=\"margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 21px;\"><span style=\"font-size:14px;\">Reset password link:<a href=https://bike-service-fe.herokuapp.com/set-password?userId=" + user.getUserId() + ">Click Here</a></span></p>\n" +
